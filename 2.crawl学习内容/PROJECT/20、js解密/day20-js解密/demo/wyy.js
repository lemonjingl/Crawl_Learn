      ...
      , q = l.BufferedBlockAlgorithm = t.extend({
        ...
        mK3x: function(a) {
            var c = this.i9b
              ...
              , k = this.blockSize
              , b = j / (4 * k)
              , b = a ? u.ceil(b) : u.max((b | 0) - this.Rj5o, 0);
            a = b * k;
            j = u.min(4 * a, j);
            if (a) {
                for (var q = 0; q < a; q += k)
    ...
    var p = CryptoJS
      ...
      , v = d.Cipher = t.extend({
        ...
        createEncryptor: function(e, a) {
            return this.create(this.GB9s, e, a)
        },
...
(function() {
    ...
    var H = [0, 1, 2, 4, 8, 16, 32, 64, 128, 27, 54]
      , d = d.AES = p.extend({
        mx3x: function() {
            for (var a = this.J9A, c = a.words, d = a.sigBytes / 4, a = 4 * ((this.bil9c = d + 6) + 1), e = this.bva3x = [], j = 0; j < a; j++)
                if (j < d)
                    e[j] = c[j];
                else {
                    var k = e[j - 1];
        ...
        encryptBlock: function(a, b) {
            this.Fn9e(a, b, this.bva3x, t, r, w, v, l)
        },
        decryptBlock: function(a, c) {
            var d = a[c + 1];
            a[c + 1] = a[c + 3];
            a[c + 3] = d;
            this.Fn9e(a, c, this.buW3x, b, x, q, n, s);
            d = a[c + 1];
            a[c + 1] = a[c + 3];
            a[c + 3] = d
        },
        Fn9e: function(a, b, c, d, e, j, l, f) {
            for (var m = this.bil9c, g = a[b] ^ c[0], h = a[b + 1] ^ c[1], k = a[b + 2] ^ c[2], n = a[b + 3] ^ c[3], p = 4, r = 1; r < m; r++)
...
function start(id) {
    ...
    var bKB5G = asrsea(JSON.stringify(d), e, f, g)
    return bKB5G
}
